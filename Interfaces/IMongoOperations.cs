...
namespace NoSqlOperations.Interfaces
{
    public interface IMongoOperations
    {
        ...
        public Task<T> GetInMongoOrderedAsync<T>(Expression<Func<T, bool>> filterExpression, Expression<Func<T, object>> orderByDescending, string collectionName) where T : class, new();
